        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('beautySpringbootApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-beautySpringbootApp-error');
                                var entityKey = httpResponse.headers('X-beautySpringbootApp-params');
                                if (errorHeader) {
